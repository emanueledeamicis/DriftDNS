# DriftDNS – Self-hosted Dynamic DNS with Web UI
...
DriftDNS is a self-hosted **Dynamic DNS (DDNS) manager with a web dashboard**, designed for homelab users and developers running services behind a dynamic public IP.
